...
class Mouse:
	...
	def update(cls):
		...
		cls.position = cls._pos()
		cls.velocity = cls.position - old
		cls.leftButton.update_status()
		cls.rightButton.update_status()
		
	@classmethod
	def show(cls):
		print(f'{cls.leftButton.name} : {cls.leftButton.status}')
		print(f'{cls.rightButton.name} : {cls.rightButton.status}')
