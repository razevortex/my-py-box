...
class CryStr(str):
	'''
 	The Password used to en-/decrypt the data with the according methods.
  	It also has a _hash property what provides a little modified but still consistent hash.
 	'''
	@property
	def _hash(self):
		hash_ = self
...
if __name__ == '__main__':
	temp = CryStr('IAmAPa55w0rd!')
	got = temp.encrypt('Im a Plaintext message')
	print(got)
